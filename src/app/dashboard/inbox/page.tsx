        ...
        <Card className="overflow-hidden">
          <CardContent className="p-0">
            {loading ? (
              ...
              <div className="py-4"><EmptyState compact icon={<Inbox />} illustration="/symbols/email-drop.png" illustrationSize={150} title="No submissions yet" description="Clients can upload via a shared link you create above." /></div>
            ) : (
              <>
                {/* Desktop table */}
        ...
        <Card className="overflow-hidden">
          <CardContent className="p-0">
            {loading ? (
              ...
              <div className="py-4"><EmptyState compact icon={<Inbox />} illustration="/symbols/email-drop.png" illustrationSize={150} title="No emailed documents yet" description="New attachments will appear here for review." /></div>
            ) : (
