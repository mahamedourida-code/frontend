  ...
  if (authLoading || !user) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="w-16 h-16 border-4 border-[#2BAAD8] border-t-transparent rounded-full animate-spin" />
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-background relative">
      ...
      <main className="container max-w-7xl mx-auto px-4 py-8 pb-24 relative z-10">
        ...
        {isProcessing && !isComplete && (
          <Card className="mb-4 border-2 border-[#2BAAD8] shadow-md max-w-sm" style={{ backgroundColor: '#fbfdfc' }}>
              ...
              <>
                ...
                <div
                  ...
                  className={cn(
                    ...
                    isDragging 
                      ? "border-[#2BAAD8] bg-primary/5 scale-[0.99]" 
                      : "border-border hover:border-[#2BAAD8]/50",
                          ...
                          <CardContent className="p-2">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
                              ...
                              <div className="flex flex-col">
                                ...
                                <div className="border-2 border-[#2BAAD8]/20 rounded-lg overflow-hidden bg-gray-50 flex items-center justify-center" style={{ maxHeight: '450px' }}>
                                  <img 
                                    src={firstImageUrl} 
                                    alt="Original" 
                              ...
                              <div className="flex flex-col">
                                ...
                                <div className="border-2 border-[#2BAAD8]/20 rounded-lg overflow-auto bg-white" style={{ maxHeight: '450px' }}>
          ...
          <div className="lg:col-span-1 space-y-4 order-3 lg:order-2">
            ...
            <Card className="border-2 border-[#2BAAD8] shadow-lg shadow-[#2BAAD8]/10" style={{ backgroundColor: '#fbfdfc' }}>
              <CardContent className="p-3">
                ...
                <select
                  className="w-full p-2.5 rounded-lg border-2 border-muted-foreground/20 bg-muted/30 text-foreground text-xs font-medium hover:border-[#2BAAD8]/50 transition-all focus:outline-none focus:border-[#2BAAD8]"
                ...
                <div className="space-y-2">
                  <button
                    ...
                    className={cn(
                      ...
                      "border-2 hover:border-[#2BAAD8]/50",
                      autoDownload
                        ? "bg-primary/10 border-[#2BAAD8]"
