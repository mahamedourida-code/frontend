...
import {
  downloadBlob,
  filenameStem,
  reviewedFileExtension,
  reviewedFilename,
  smartOutputFilename,
} from "@/components/dashboard/review/helpers"
import type {
  DurableWorkspaceResultFile,
  ResultPreview,
  ResultSourceTrace,
  WorkspaceOutputMode,
} from "@/components/dashboard/review/types"
  ...
  return (
    ...
    >
      ...
      <ShareDialog
        ...
        onLinkedInMessage={handleLinkedInMessage}
