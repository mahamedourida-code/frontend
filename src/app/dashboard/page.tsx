    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <div className="w-16 h-16 border-4 border-[#4FB9FF] border-t-transparent rounded-full animate-spin mx-auto mb-4" />
      ...
      <div className="flex-1 overflow-auto relative z-10">
        <div className="container max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-6 lg:mb-8">
            ...
            <Card className="border-2 border-[#4FB9FF] shadow-lg shadow-[#4FB9FF]/10 relative" style={{ backgroundColor: '#fbfdfc' }}>
              <CardContent className="p-3 lg:p-4">
                <div className="flex items-center justify-between">
                  <div>
          ...
          {/* Chart Section */}
          <Card className="bg-transparent border-2 border-[#4FB9FF] shadow-lg shadow-[#4FB9FF]/10">
