      ...
      <header className="border-b bg-white dark:bg-gray-900 relative z-10">
        <div className="container flex h-12 lg:h-14 max-w-5xl items-center justify-between px-3 sm:px-4 lg:px-6">
          <div className="flex items-center gap-2">
            ...
            <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-white dark:bg-white border-2 border-[#4FB9FF] shadow-sm">
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    "bg-white dark:bg-white rounded-xl border-2 border-[#4FB9FF] shadow-lg shadow-[#4FB9FF]/10",
