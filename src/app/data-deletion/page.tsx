...
import { Trash2, AlertCircle, Clock, CheckCircle2, ChevronLeft } from "lucide-react"
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container max-w-4xl mx-auto px-4 py-12">
        ...
        <p className="text-muted-foreground mb-8">
          Learn how to delete your data from AxLiner
        </p>
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              If you used Facebook to share files generated by AxLiner, please note:
            </p>
          ...
          <section>
            ...
            <div className="bg-orange-500/10 border border-orange-500/20 rounded-lg p-5">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                If you wish to use AxLiner again in the future, you will need to create a new account 
                with a fresh start.
              </p>
            </div>
          </section>
            ...
            <div className="bg-muted/50 rounded-lg p-6 border">
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="font-mono text-sm">support@AxLiner.com</p>
                </div>
                <div>
