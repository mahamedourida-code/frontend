...
import { Keyboard, Clock, BarChart, ChevronLeft } from "lucide-react";
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-foreground mb-6">
            Eliminate Manual <span className="bg-gradient-to-r from-primary via-[#7C3BED] to-[#7C3BED] bg-clip-text text-transparent">Data Entry</span>
          </h1>
