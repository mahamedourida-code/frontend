          ...
          <CardContent className="p-6 sm:p-8">
            ...
            <div className="mb-7 text-center">
              ...
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
                Continue with Google to access your AxLiner workspace.
              </p>
            </div>
            ...
            <p className="mt-7 text-center text-sm text-muted-foreground">
              New to AxLiner?{" "}
              <Link href={`/sign-up?next=${encodeURIComponent(nextPath)}`} className="font-bold text-primary hover:underline">
                Create an account
              </Link>
            </p>
          </CardContent>
